# a custom Keras layer for attention from fast.ai course taught by Jeremy Howard
# https://github.com/fastai/courses/blob/master/deeplearning2/attention_wrapper.py
